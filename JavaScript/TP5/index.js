...
function loadQuestion(){
    const randomCurrentQuestion = Math.floor((Math.random()) *  questionList.length)
    console.log(randomCurrentQuestion)
    const currentQuestionData = questionList[randomCurrentQuestion]
